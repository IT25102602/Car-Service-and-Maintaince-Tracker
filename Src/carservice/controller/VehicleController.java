...
/**
 * REST Controller – All CRUD endpoints for Vehicle Management
 *
 * GET    /api/vehicles                    → All vehicles (admin)
 * GET    /api/vehicles/{id}               → Get by ID      (READ)
 * GET    /api/vehicles/customer/{cid}     → By customer    (READ)
 * GET    /api/vehicles/search?cid=&q=     → Search         (READ)
 * POST   /api/vehicles                    → Create         (CREATE)
 * PUT    /api/vehicles/{id}               → Update         (UPDATE)
 * DELETE /api/vehicles/{id}               → Delete         (DELETE)
 * GET    /api/vehicles/{id}/recommendation → Polymorphic recommendation
 */
@RestController
